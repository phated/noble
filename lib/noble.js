    ...
    if (service.uuid === serviceUuid) {  
      for (var j = 0; j < service.characteristics.length; j++) {
        ...
        if (characteristic.uuid === characteristicUuid) {
          this.emit('peripheralServiceCharacteristicRead', peripheral, service, characteristic, data);
          peripheral.emit('serviceCharacteristicRead', service, characteristic, data);
          service.emit('characteristicRead', characteristic, data);
